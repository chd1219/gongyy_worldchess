...
createjs = createjs || {},
ss = ss || {});
var lib, images, createjs, ss, LABEL = {};
LABEL.j = lib.ChessLabelRedJiang,
LABEL.c = lib.ChessLabelRedJu,
LABEL.m = lib.ChessLabelRedMa,
LABEL.p = lib.ChessLabelRedPao,
LABEL.s = lib.ChessLabelRedShi,
LABEL.x = lib.ChessLabelRedXiang,
LABEL.z = lib.ChessLabelRedZu,
LABEL.J = lib.ChessLabelBlackJiang,
LABEL.C = lib.ChessLabelBlackJu,
LABEL.M = lib.ChessLabelBlackMa,
LABEL.P = lib.ChessLabelBlackPao,
LABEL.S = lib.ChessLabelBlackShi,
LABEL.X = lib.ChessLabelBlackXiang,
LABEL.Z = lib.ChessLabelBlackZu,
function(t, s, i, e) {
    var n;
    t.properties = {
        width: 550,
