...
//	this.box.appendChild(this.comments_title);
	...
	this.banner.className = "downloadDDiv";
	this.banner.id="btn_download";
	this.banner.innerHTML='<img src="img/appdownload.png" width="100%"  />';
	this.box.appendChild(this.banner);
